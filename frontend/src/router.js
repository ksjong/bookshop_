...
import BookBookManagementManager from "./components/listers/BookBookManagementCards"
import BookBookManagementDetail from "./components/listers/BookBookManagementDetail"
...
export default new Router({
    ...
    routes: [
            ...
            {
                path: '/books/bookManagements',
                name: 'BookBookManagementManager',
                component: BookBookManagementManager
            },
            {
                path: '/books/bookManagements/:id',
                name: 'BookBookManagementDetail',
                component: BookBookManagementDetail
            },
